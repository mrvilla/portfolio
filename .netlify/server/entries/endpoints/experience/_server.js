const companies = [
  {
    ...
    details: "Rebuilt main website.\nCollaborating closely with other Engineers, UI/UX team to establish and shape a design system.\nUpdated new fresh corporate colors, typography, spacing and other variables across legacy sites and laying the base foundation of the new theme to the main site and project. Worked closely with Marketing and UI/UX team to enhance the traveler's experience, while contributing daily with team mates building components and updating them to add to the project.",
