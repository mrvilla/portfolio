	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				endpoint: __memo(() => import('../server/entries/endpoints/experience/_server.js'))
			},
			{
				id: "/photography",
				pattern: /^\/photography\/?$/,
				...
				endpoint: __memo(() => import('../server/entries/endpoints/photography/_server.js'))
			},
			{
				id: "/portfolio",
				pattern: /^\/portfolio\/?$/,
				...
				endpoint: __memo(() => import('../server/entries/endpoints/portfolio/_server.js'))
			},
			{
				id: "/portfolio/[slug]",
				pattern: /^\/portfolio\/([^/]+?)\/?$/,
