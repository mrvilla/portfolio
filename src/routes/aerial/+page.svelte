<script>
	...
	function updateProgress(video) {
		...
		video.closest('.aerial__item-background').querySelector('.progress').style.strokeDashoffset =
			100 - progress;
...
<style lang="scss">
	...
	.aerial__item-background {
		background: repeating-linear-gradient(45deg, #8e8d8d, #b2b2b2 10px, #c7c7c7 10px, #e6e6e6 20px);
